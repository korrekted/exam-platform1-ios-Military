...
final class OSlideDateView: OSlideView {
...
private extension OSlideDateView {
...
private extension OSlideDateView {
    ...
    func makeTitleLabel() -> UILabel {
        ...
        view.attributedText = "Onboarding.SlideDate.Title".localized.attributed(with: attrs)
        view.translatesAutoresizingMaskIntoConstraints = false
        addSubview(view)
        return view
    }
    ...
    func makeDatePickerView() -> PIDatePicker {
        ...
        view.textColor = UIColor(integralRed: 141, green: 169, blue: 132)
