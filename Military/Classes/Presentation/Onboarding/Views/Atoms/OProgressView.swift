...
private extension OProgressView {
    func createCircularPath() {
        ...
        circleLayer.strokeColor = UIColor(integralRed: 145, green: 200, blue: 195, alpha: 0.3).cgColor
        ...
        progressLayer.strokeColor = UIColor(integralRed: 141, green: 169, blue: 132).cgColor
