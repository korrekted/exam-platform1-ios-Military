...
final class OSlideTestsCountView: OSlideView {
...
// MARK: Private
private extension OSlideTestsCountView {
    @objc
...
private extension OSlideTestsCountView {
    func makeConstraints() {
        ...
        NSLayoutConstraint.activate([
            ...
            imageView.heightAnchor.constraint(equalToConstant: ScreenSize.isIphoneXFamily ? 271.scale : 219.scale),
            imageView.widthAnchor.constraint(equalToConstant: 216.scale),
...
private extension OSlideTestsCountView {
    func makeTitleLabel() -> UILabel {
        ...
        view.attributedText = "Onboarding.SlideTestsCount.Title".localized.attributed(with: attrs)
    ...
    func makeSlider() -> UISlider {
        ...
        view.minimumValue = 1
        view.maximumValue = 7
        view.minimumTrackTintColor = UIColor(integralRed: 141, green: 169, blue: 132)
        view.maximumTrackTintColor = UIColor(integralRed: 145, green: 200, blue: 195, alpha: 0.3)
