...
class MainProgressView: UIView {
    ...
    override func draw(_ rect: CGRect) {
        drawProgress(for: bigProgress, multiplerSize: 1, color: UIColor(integralRed: 247, green: 214, blue: 137))
        drawProgress(for: mediumProgress, multiplerSize: 0.8, color: UIColor(integralRed: 141, green: 169, blue: 132))
        drawProgress(for: smallProgress, multiplerSize: 0.6, color: UIColor(integralRed: 194, green: 151, blue: 112))
    }
}
